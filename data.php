...
if (isset($_GET['op']) && $_GET['op'] == 'delete') {
    $id = $_GET['id'];
    $sql_delete = "DELETE FROM data_diri WHERE id_datadiri = '$id'";
...
<body>
    <div class="judul text-center"><strong>DATA DIRI MASYARAKAT</strong></div>
    <div class="mx-auto">
        <p>
            <a href="isi_data.php" class="tbl-pink">Tambah Data Diri</a>
