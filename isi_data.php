...
if ($op == 'edit') {
    $id = $_GET['id'];
    $sql1 = "SELECT * FROM data_diri WHERE id = '$id'";
...
if (isset($_POST['simpan'])) {
    ...
    if ($nama && $tgl_lahir && $no_ktp && $alamat && $email) {
        if ($op == 'edit') { // untuk Update
            $sql1 = "UPDATE data_diri SET nama = '$nama', tgl_lahir = '$tgl_lahir', no_ktp = '$no_ktp', alamat = '$alamat', email = '$email' WHERE id_datadiri = '$id'";
            $q1 = mysqli_query($koneksi, $sql1);
            if ($q1) {
            ...
            $sql1 = "INSERT INTO data_diri (nama, tgl_lahir, no_ktp, alamat, email) VALUES ('$nama', '$tgl_lahir', '$no_ktp', '$alamat', '$email')";
            $q1 = mysqli_query($koneksi, $sql1);
            if ($q1) {
    ...
    <div class="mx-auto">
        <div class="card">
            <div class="card-header">
                <strong><?php echo ($op == 'edit') ? "Edit" : " "; ?> Data Diri</strong>
            </div>
            <div class="card-body">
            <?php 
            if($error){
